  ...
  return (
    <div className=" h-full w-full bg-black text-white">
      ...
      <div className=" flex gap-6 p-6 items-center justify-center">
              ...
              <div className="relative p-6 rounded-lg shadow-lg leading-none bg-black text-center cursor-pointer ">
                      <h2 className=" text-xs font-medium md:text-lg md:font-medium animate-pulse" >Try saying : </h2>
                      <p className=" text-xs md:text-base md:mt-4 animate-pulse ">Go Back</p>
                  </div>
              </div>
               <div className=" relative group">
               <div className="absolute -inset-1 bg-gradient-to-r from-pink-600 to-purple-600 rounded-lg blur opacity-75 group-hover:opacity-100 transition duration-1000 group-hover:duration-200 animate-tilt "></div>
               <div className="relative p-6 rounded-lg shadow-lg leading-none bg-black text-center cursor-pointer">
                       <h2 className="text-xs font-medium md:text-lg md:font-medium animate-pulse ">Try saying : </h2>
                       <p className=" text-xs md:text-base md:mt-4 animate-pulse ">Open Article Number [1]</p>
                   </div>
               </div>
               </div>:null
      }
